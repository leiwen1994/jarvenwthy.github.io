...
public class PublicTests {
	...
	public void testReverseSentence3() {
		String result = w.reverseSentence("university of maryland");
		String expected = "maryland of university";
		assertEquals(expected, result);
	}
	...
	public void testAnagram4() {
		boolean result = w.anagram("cat", "act");
		assertTrue(result);
	}
	
	@Test
	public void testAnagram5() {
		boolean result = w.anagram("aabbcc", "caaabb");
		assertFalse(result);
	}
